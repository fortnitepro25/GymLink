        ...
        {currentPage === 'home' && (
          <div className="text-center py-20">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <button onClick={() => setCurrentPage('dashboard')} className="bg-orange-600 hover:bg-orange-700 px-12 py-4 rounded-lg text-lg font-medium">View Progress</button>
              <button onClick={() => setCurrentPage('log')} className="bg-zinc-800 hover:bg-zinc-700 border border-zinc-600 px-12 py-4 rounded-lg text-lg font-medium">Log Workout</button>
              <button onClick={() => setCurrentPage('chat')} className="bg-zinc-800 hover:bg-zinc-700 border border-zinc-600 px-12 py-4 rounded-lg text-lg font-medium">Join Chat Room</button>
            </div>
          </div>
        )}
