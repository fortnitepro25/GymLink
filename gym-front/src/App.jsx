        ...
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          ...
          <div className="flex gap-8">
            <button
              ...
              className={`px-5 py-2 rounded ${currentPage === "home" ? "text-orange-500" : ""}`}
            >
              Home
            </button>
            <button
              onClick={() => setCurrentPage("dashboard")}
              className={`px-5 py-2 rounded ${currentPage === "dashboard" ? "text-orange-500" : ""}`}
            >
              Progress
            </button>
            <button
              onClick={() => setCurrentPage("log")}
              className={`px-5 py-2 rounded ${currentPage === "log" ? "text-orange-500" : ""}`}
            >
              Log Workout
            </button>
            <button
              onClick={() => setCurrentPage("chat")}
              className={`px-5 py-2 rounded ${currentPage === "chat" ? "text-orange-500" : ""}`}
            >
              Chat Room
            </button>
          </div>
