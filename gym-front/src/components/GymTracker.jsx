...
export default function GymTracker({ setPage, user, onLogout }) {
  // ------------------- STATE -------------------
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#0a0a0a", color: "#eee" }}>
      
      {/* NEW NAVBAR - Shows Logged In Status */}
      <div style={{
        display: "flex",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
          <div style={{ textAlign: "right" }}>
            <strong>Welcome, {user?.name || "Gym Bro"}</strong><br />
            <small style={{ color: "#22c55e" }}>{user?.email}</small>
          </div>
                ...
                <svg width="520" height="340" style={{ background: "#2a2a2a", borderRadius: "12px", padding: "10px" }}>
                  ...
                  {graphPoints.map((p, i) => (
                    <g key={i}>
                      ...
                      <text x={p.x + 20} y={p.y + 10} fill="#ccc" fontSize="12" textAnchor="middle">
                        {p.weight}kg
                      </text>
                      <text x={p.x + 20} y={330} fill="#888" fontSize="11" textAnchor="middle">
                        {p.date.slice(5)}
                      </text>
                    </g>
                  ))}
